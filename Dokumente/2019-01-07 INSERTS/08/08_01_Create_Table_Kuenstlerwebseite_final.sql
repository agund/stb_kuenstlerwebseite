...
CREATE TABLE    kuenstler (
	...
	portrait		  TEXT(1024)   NULL DEFAULT NULL,
...
CREATE TABLE bild (
	...
	Beschreibung		TEXT(2048)   NOT NULL,
...
CREATE TABLE kategorie (
	...
	Beschreibung		TEXT(4096) NOT NULL
...
CREATE TABLE /*! IF NOT EXISTS */ kategorie(
  kategorie_ID   INT UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
  Bezeichung	VARCHAR(50) NOT NULL UNIQUE,
