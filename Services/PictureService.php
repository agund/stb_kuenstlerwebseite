...
class PictureService
{
    ...
    *
    *************************************************************************** */
    public function my_arr( $arr, $out = true )
    {
    ...
    *
    *************************************************************************** */
    public function check_picdir( $pdir )
    {
        $html = '';
        $ok = true;
    ...
    *
    *************************************************************************** */
    public function get_pic_arr( $picdir, $log=FALSE )
    {
        // Name der Logdatei
    ...
    *
    *************************************************************************** */
    public function bildbearbeitung( $pic_arr, $small_size, $big_size, $picdir )
    {
    ...
    *
    *************************************************************************** */
    public function create_pngFiles( $picname, $small_size, $big_size, $picdir )
    ...
    *
    *************************************************************************** */
    public function html_errordiv( $errno )
    {
    switch ( $errno )
    {
        case  1 :  
